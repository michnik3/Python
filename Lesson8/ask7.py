...
print(family["father"]["name"] + ": " + str(family["father"]["quotes"][randrange(len(family["father"]["quotes"]))]))
print(family["mother"]["name"] + ": " + str(family["mother"]["quotes"][randrange(len(family["mother"]["quotes"]))]))
